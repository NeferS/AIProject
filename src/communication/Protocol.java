...
public class Protocol {
	...
	/**Possibili direzioni lungo le quali una o pi� pedine possono essere mosse.*/
	 ...
	 * @param port porta sulla quale il server � in ascolto
	...
	/**Chiude tutte le connessioni di I/O utilizzate.*/
