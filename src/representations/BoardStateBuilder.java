...
public class BoardStateBuilder {
	...
	// Date le bitboard che individuano i pezzi del giocatore, quelli
	// dell'avversario, le posizioni occupate dal giocatore,
	// il numero n + 1 di pedine posizionate sulla casella srcSquare e la casella di
	// destinazione, il metodo costruisce un
	// nuovo RepresentationNode che rappresenta il nuovo stato della scacchiera dopo
	// aver effettuato la mossa individuata.
	public static BitboardRepresentationNode calculateNonCaptureMove(BitSet[] playerPieces, BitSet[] enemyPieces,
			BitSet playerOccupiedSquares, int playerStackSize, int srcSquare, int dstSquare, String encodedSrcSquare,
			String direction, int distance, Color playerColor, Color enemyColor) {

		BitboardRepresentationNode validMove = new BitboardRepresentationNode();
		BitSet[] newPlayerPieces = playerPieces.clone();

		String encodedMove = encodedSrcSquare.concat(",").concat(direction).concat(",")
	...
	public static BitboardRepresentationNode calculateCaptureMove(BitSet[] playerPieces, BitSet[] enemyPieces,
			int playerStackSize, int enemyStackSize, int srcSquare, int dstSquare, String encodedSrcSquare,
			String direction, int distance, Color playerColor, Color enemyColor) {
		...
		// String direction =
		// this.exitMovesDirections[this.playerColor.ordinal()][srcSquare];
	...
	public static BitboardRepresentationNode calculateExitMove(BitSet[] playerPieces, BitSet[] enemyPieces,
			int playerStackSize, int srcSquare, String encodedSrcSquare, String direction, int distance,
	...
	// Dato l'array di 12 bitboards di un giocatore, calcola una bitboard relativa a
	// tutte le posizioni occupate
	public static BitSet calculateOccupiedSquares(BitSet[] pieces) {
	...
	// Dati i due array di 12 bb ciascuno (uno per giocatore), calcola una bb
	// relativa a tutte le caselle vuote
	public static BitSet calculateEmptySquares(BitSet occupiedSquares1, BitSet occupiedSquares2) {
